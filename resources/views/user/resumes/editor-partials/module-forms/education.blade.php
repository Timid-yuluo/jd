    ...
    <div class="editor-form-stack">
        <div class="editor-field-surface">
            <div class="d-flex align-items-center gap-2 flex-wrap">
                ...
                <span class="small text-muted">可一键粘贴整段教育经历后再拆分</span>
            </div>
        </div>
                ...
                <div class="editor-field-surface">
                    <div class="editor-surface-head">
                        <div>
                            ...
                            <div class="editor-surface-note">补充学校、时间和地点，右侧会自动形成更完整的排版结构。</div>
                        </div>
                    </div>
                    <div class="row g-2">
                        <div class="col-6">
                ...
                <div class="editor-field-surface">
                    <div class="editor-surface-head">
                        <div>
                            ...
                            <div class="editor-surface-note">用 1 到 2 句话概括学习方向、研究重点或校园经历。</div>
                        </div>
                    </div>
                ...
                <div class="editor-field-surface">
                    <div class="editor-surface-head">
                        <div>
                            ...
                            <div class="editor-surface-note">建议补课程、奖项、项目或研究成果。</div>
                        </div>
                    </div>
            ...
            <div class="editor-field-surface">
                <div class="editor-surface-head">
                    <div>
                        ...
                        <div class="editor-surface-note">首行可写“学校/专业 | 时间 | 地点”，其余行可写描述与条目（条目前加 -）。</div>
                    </div>
                </div>
                <textarea class="form-control form-control-sm"
                    rows="8"
                    x-model="mod.data.content_raw"
                    placeholder="北京大学 计算机科学与技术 | 2022.09 - 2026.06 | 北京&#10;主修数据库系统，GPA 3.8/4.0。&#10;- 国家奖学金&#10;- ACM 校赛一等奖"></textarea>
                <div class="d-flex align-items-center justify-content-between mt-2">
                    <div class="small text-muted">点击按钮后会自动拆分到结构化字段。</div>
                ...
                <div class="border rounded p-2 mt-2 bg-light-subtle" x-show="moduleRawPreviewHasData(mod)">
                    ...
                    <div class="alert alert-warning py-2 mb-2" x-show="moduleRawPreviewWarnings(mod).length > 0">
                        ...
                        <template x-for="(warn, warnIdx) in moduleRawPreviewWarnings(mod)" :key="`warn-edu-${warnIdx}`">
                            <div class="small" x-text="`• ${warn}`"></div>
                        </template>
                    </div>
                    <div class="small text-muted mb-1" x-show="moduleRawPreview(mod).subtitle">学校/专业：<span class="text-dark" x-text="moduleRawPreview(mod).subtitle"></span></div>
