...
@section('title', '次卡订单支付')
@section('page-pretitle', '会员中心')
@section('page-title', '次卡订单支付')
            ...
            <div class="card-body">
                <div class="mb-4">
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            <div class="text-secondary small">次卡</div>
                            <div class="fw-semibold">{{ $order->creditPack->name ?? '-' }}</div>
                        </div>
                        <div class="col-6">
                            <div class="text-secondary small">次数</div>
                            <div>{{ $order->creditPack->credits ?? 0 }} 次</div>
                        </div>
                        <div class="col-6">
                ...
                @if(!empty($enabledMethods))
                    <form method="POST" action="{{ route('user.membership.credit-payment.method', $order->order_no) }}" class="mb-3">
                        @csrf
