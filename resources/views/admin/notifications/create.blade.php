            ...
            <div class="card-body">
                <form action="{{ route('admin.notifications.store') }}" method="POST" id="notification-form">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-selectgroup">
                            <label class="form-selectgroup-item">
                                <input type="radio" name="type" value="announcement" class="form-selectgroup-input" {{ old('type', 'announcement') === 'announcement' ? 'checked' : '' }}>
                                <span class="form-selectgroup-label">
                                    <i class="ti ti-speakerphone text-blue me-1"></i>系统公告
                                </span>
                            </label>
                            <label class="form-selectgroup-item">
                                <input type="radio" name="type" value="feature" class="form-selectgroup-input" {{ old('type') === 'feature' ? 'checked' : '' }}>
                                <span class="form-selectgroup-label">
                                    <i class="ti ti-rocket text-green me-1"></i>功能更新
                                </span>
                            </label>
                            <label class="form-selectgroup-item">
                                <input type="radio" name="type" value="maintenance" class="form-selectgroup-input" {{ old('type') === 'maintenance' ? 'checked' : '' }}>
                                <span class="form-selectgroup-label">
                                    <i class="ti ti-tool text-yellow me-1"></i>维护通知
                                </span>
                            </label>
                            <label class="form-selectgroup-item">
                                <input type="radio" name="type" value="warning" class="form-selectgroup-input" {{ old('type') === 'warning' ? 'checked' : '' }}>
                                <span class="form-selectgroup-label">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="content" id="content-editor" class="form-control" rows="10" required maxlength="5000" data-tinymce data-tinymce-height="320">{{ old('content') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-selectgroup form-selectgroup-boxes d-flex flex-column">
                            <label class="form-selectgroup-item flex-fill mb-2">
                                <input type="radio" name="channel" value="site" class="form-selectgroup-input" {{ old('channel', 'both') === 'site' ? 'checked' : '' }} data-toggle="channel-options">
                            ...
                            <label class="form-selectgroup-item flex-fill mb-2">
                                <input type="radio" name="channel" value="email" class="form-selectgroup-input" {{ old('channel') === 'email' ? 'checked' : '' }} data-toggle="channel-options">
                                <div class="form-selectgroup-label d-flex align-items-center p-3">
                                    <div class="me-3">
                                        <span class="form-selectgroup-check"></span>
                                    </div>
                            ...
                            <label class="form-selectgroup-item flex-fill">
                                <input type="radio" name="channel" value="both" class="form-selectgroup-input" {{ old('channel', 'both') === 'both' ? 'checked' : '' }} data-toggle="channel-options">
                                <div class="form-selectgroup-label d-flex align-items-center p-3">
                                    <div class="me-3">
                                        <span class="form-selectgroup-check"></span>
                                    </div>
                    ...
                    {{-- 邮件模板选择 --}}
                    <div id="email-template-options" class="mb-3 {{ old('channel', 'both') === 'site' ? 'd-none' : '' }}">
                        ...
                        <div class="form-hint">
                            <a href="{{ route('admin.notifications.email-templates.create') }}" target="_blank">
                                <i class="ti ti-plus me-1"></i>创建新模板
                            </a>
                        </div>
                    ...
                    <div class="mb-0">
                        ...
                        <div class="form-selectgroup form-selectgroup-boxes d-flex flex-column">
                            <label class="form-selectgroup-item flex-fill mb-2">
                                <input type="radio" name="target_type" value="all" class="form-selectgroup-input" {{ old('target_type', 'all') === 'all' ? 'checked' : '' }} data-toggle="target-options">
                                <div class="form-selectgroup-label d-flex align-items-center p-3">
                                    <div class="me-3">
                                        <span class="form-selectgroup-check"></span>
                                    </div>
                            ...
                            <label class="form-selectgroup-item flex-fill mb-2">
                                <input type="radio" name="target_type" value="roles" class="form-selectgroup-input" {{ old('target_type') === 'roles' ? 'checked' : '' }} data-toggle="target-options">
                                <div class="form-selectgroup-label d-flex align-items-center p-3">
                                    <div class="me-3">
                                        <span class="form-selectgroup-check"></span>
                                    </div>
                            ...
                            <label class="form-selectgroup-item flex-fill">
                                <input type="radio" name="target_type" value="users" class="form-selectgroup-input" {{ old('target_type') === 'users' ? 'checked' : '' }} data-toggle="target-options">
                                <div class="form-selectgroup-label d-flex align-items-center p-3">
                                    <div class="me-3">
                                        <span class="form-selectgroup-check"></span>
                                    </div>
                    ...
                    {{-- 角色选择 --}}
                    <div id="roles-options" class="mb-3 {{ old('target_type') === 'roles' ? '' : 'd-none' }}">
                        <label class="form-label">选择角色</label>
                        <div class="form-selectgroup form-selectgroup-pills">
                            @foreach ($roles as $key => $label)
                            <label class="form-selectgroup-item">
                                <input type="checkbox" name="target_roles[]" value="{{ $key }}" class="form-selectgroup-input" {{ in_array($key, old('target_roles', [])) ? 'checked' : '' }}>
                    ...
                    {{-- 用户选择 --}}
                    <div id="users-options" class="mb-3 {{ old('target_type') === 'users' ? '' : 'd-none' }}">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-selectgroup form-selectgroup-boxes d-flex flex-column">
                            <label class="form-selectgroup-item flex-fill mb-2">
                                <input type="radio" name="send_type" value="draft" class="form-selectgroup-input" {{ old('send_type', 'draft') === 'draft' ? 'checked' : '' }} data-toggle="send-type-options">
                                <div class="form-selectgroup-label d-flex align-items-center p-3">
                                    <div class="me-3">
                                        <span class="form-selectgroup-check"></span>
                                    </div>
                            ...
                            <label class="form-selectgroup-item flex-fill mb-2">
                                <input type="radio" name="send_type" value="now" class="form-selectgroup-input" {{ old('send_type') === 'now' ? 'checked' : '' }} data-toggle="send-type-options">
                                <div class="form-selectgroup-label d-flex align-items-center p-3">
                                    <div class="me-3">
                                        <span class="form-selectgroup-check"></span>
                                    </div>
                            ...
                            <label class="form-selectgroup-item flex-fill">
                                <input type="radio" name="send_type" value="later" class="form-selectgroup-input" {{ old('send_type') === 'later' ? 'checked' : '' }} data-toggle="send-type-options">
                                <div class="form-selectgroup-label d-flex align-items-center p-3">
                                    <div class="me-3">
                                        <span class="form-selectgroup-check"></span>
                                    </div>
                    ...
                    {{-- 定时发送时间选择 --}}
                    <div id="scheduled-time-options" class="mb-3 {{ old('send_type') === 'later' ? '' : 'd-none' }}">
                    ...
                    <div class="form-footer">
                        <button type="submit" class="btn btn-primary" id="submit-btn">
                            <i class="ti ti-send me-1"></i>保存通知
                        </button>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="list-unstyled mb-0">
                    <li class="mb-2"><i class="ti ti-info-circle text-info me-1"></i> 不勾选「立即发送」将保存为草稿</li>
                    <li class="mb-2"><i class="ti ti-info-circle text-info me-1"></i> 已发送的通知不能编辑</li>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <div class="alert" id="preview-alert">
                    <h5 class="alert-title" id="preview-title">通知标题</h5>
                    <div class="text-secondary" id="preview-content">通知内容将显示在这里...</div>
                </div>
            </div>
        </div>
    </div>
...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/pages/admin-notifications-create.css') }}">
@endpush
